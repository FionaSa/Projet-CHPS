...
static PyObject *DNAb_detecting_mutations(PyObject *self, PyObject *args)
{
	...
	m.size = calloc(sizeof(unsigned long long), sizeof(unsigned long long)*5);
	m.start_mut = calloc(sizeof(unsigned long long), sizeof(unsigned long long)*5);
	m.end_mut = calloc(sizeof(unsigned long long), sizeof(unsigned long long)*5);
